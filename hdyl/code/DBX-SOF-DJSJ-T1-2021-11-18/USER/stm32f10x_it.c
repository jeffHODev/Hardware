...
* Return         : None
*******************************************************************************/
// DMAChannel5_IRQHandler usart1_rx
		...
		case 1: // 开机音
						...
						else
						{
							if(music!=Music_Code_1[codenum])
							{
								...
								Set_Music_Value(Music_Code_1[codenum]);								
							}
						}
						break;
		case 2: // 按键音
						if(codenum++>=MUSIC_NUM2-1)
						{
							Speak_Flage=0;
							codenum=0;
							music=0;
						...
						else
						{
							if(music!=Music_Code_2[codenum])
							{
								...
								Set_Music_Value(Music_Code_2[codenum]);								
							}
						}			
						break;
		case 3: // 结束音
						if(codenum++>=MUSIC_NUM3-1)
						{
							Speak_Flage=0;
							codenum=0;
							music=0;
						...
						else
						{
							if(music!=Music_Code_3[codenum])
							{
								...
								Set_Music_Value(Music_Code_3[codenum]);								
							}
						}			
						break;
		case 4: // 报警音
						if(codenum++>=MUSIC_NUM4-1)
						{
							Speak_Flage=0;
							codenum=0;
							music=0;
						...
						else
						{
							if(music!=Music_Code_4[codenum])
							{
								...
								Set_Music_Value(Music_Code_4[codenum]);								
							}
						}								
						break;
		default : break;
