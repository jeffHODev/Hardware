...
public class NewBloodPressurePresenter extends BasePresenter<NewBloodPressureView> {
    public NewBloodPressurePresenter(NewBloodPressureView baseView) {
        super(baseView);
    }
     ...
     * 登录
     */
    public void NewBloodPressurePresenterhttp(BloodPressureBean bloodPressureBean) {


        addDisposable(apiServer.NewBloodPressurePresenterhttp(bloodPressureBean), new BaseObserver<BloodPressureBean>(baseView) {
            @Override
            public void onSuccess(BaseJsonMsg<BloodPressureBean> o) {
