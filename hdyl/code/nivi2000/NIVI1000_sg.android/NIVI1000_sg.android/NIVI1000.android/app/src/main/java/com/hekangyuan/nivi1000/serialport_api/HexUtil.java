...
public class HexUtil {
    ...
    public static byte[] test = {0x03, 0x02, 0x01, 0x02, 0x32, 0x32, 0x32, 0x2E, 0x30, 0x34, 0x35, 0x2E, 0x30, 0x34, 0x32, 0x2E, 0x03, 0x02, 0x32, 0x32, 0x32, 0x2E, 0x30, 0x34, 0x35, 0x2E, 0x30, 0x34, 0x32, 0x2E, 0x03, 0x02, 0x02, 0x02,
            0x32, 0x32, 0x32, 0x2E, 0x30, 0x34, 0x35, 0x2E, 0x30, 0x34, 0x32, 0x2E, 0x03, 0x02, 0x32, 0x32, 0x32, 0x2E, 0x30, 0x34, 0x35, 0x2E, 0x30, 0x34, 0x32, 0x2E, 0x03, 0x02};
    ...
    public static byte[] Dec2Bytes(int DecData) {
        byte[] bytes = HexUtil.HexString2Bytes(Integer.toHexString(DecData));//得到数据的字节数组
        return bytes;
    }

    public static String Dec2HexString(int DecData) {
        return encodeHexStr(Dec2Bytes(DecData));
    }


    public static byte[] getSendBytes(int[] data) {
        StringBuilder hexstr = new StringBuilder();
        for (int i = 0; i < data.length; i++) {
            hexstr = hexstr.append(byte2HexStr(Dec2Bytes(data[i])));
        }
        byte[] bytes = HexString2Bytes(hexstr.toString());
        return bytes;
    ...
    public static byte[] byteReverse(byte[] buff) {
