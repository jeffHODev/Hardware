...
public class UploadEcgPresenter extends BasePresenter<UploadEcgView> {
    public UploadEcgPresenter(UploadEcgView baseView) {
        super(baseView);
    }
     ...
     * 上传心电数据
     */
    public void UploadEcghttp(EcgMonitorBean ecgMonitorBean) {
