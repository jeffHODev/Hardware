...
public interface GetPersonalInformationListView extends BaseView {
    void onMainSuccess(BaseJsonMsg<PatientBaseBean> o);
    void onPerSuccess  (BaseJsonMsg<PatientBaseBean> o);
