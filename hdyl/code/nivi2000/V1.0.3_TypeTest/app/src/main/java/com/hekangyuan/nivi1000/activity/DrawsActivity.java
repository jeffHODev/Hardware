...
//                CLibrary.INSTANCE2.FilterMibun(ecgsf, pecg, sampleNum, (short) 25);
...
//                short res;
//                try{
//                    res = Hpassys.RQT_Analysis(ecgfp.getFloatArray(0, sampleNum), pecg.getFloatArray(0, sampleNum), sampleNum, analHPAStructs, analHPADataStruct);
//                }catch (Exception e){
//                    freePointer(pecg);
//                    freePointer(ecgfp);
//                    ToastUtils.showToastLong(DrawsActivity.this,"超收缩压心电数据不规范，请重新检测");
...
//                        ToastUtils.showToastLong(DrawsActivity.this,"超收缩压脉搏数据不规范，请重新检测");
//                        hypapgs = null;
//                        return;
//                    }
//                }
...
//                CLibrary.INSTANCE2.Filter(apgsf, japgfP, apgsSize, (short) 25);
//                CLibrary.INSTANCE2.FilterMibun(apgsf, japgfP, apgsSize, (short) 25);
...
//                CLibrary.INSTANCE2.FilterMibun(ecgdf, pecgd, ecgdSize, (short) 25);
...
//                short resd;
//                try{
//                    resd = Hpassys.RQT_Analysis(ecgfpd.getFloatArray(0, ecgdSize), pecgd.getFloatArray(0, ecgdSize), ecgdSize, analHPAStructd, analHPADataStruct);
//                }catch (Exception e){
//                    freePointer(pecgd);
//                    freePointer(ecgfpd);
//                    ToastUtils.showToastLong(DrawsActivity.this,"低舒张压心电数据不规范，请重新检测");
...
//                CLibrary.INSTANCE2.Filter(apgdf, japgdfP, apgdSize, (short) 25);
//                CLibrary.INSTANCE2.FilterMibun(apgdf, japgdfP, apgdSize, (short) 25);
...
//                }catch(Exception e){
//                    ToastUtils.showToastLong(DrawsActivity.this,"左颈动脉心电数据不规范，请重新检测");
//                    ecgPl = null;
//                    freePointer(jSnl);
//                    freePointer(kSnlP);
//                    break;
...
//
//                for (apgLi = 0; apgLi < apgLRTopNum; apgLi++) {
//                    apgLdd = 0; apgLss = 0;
...
//
//                for (apgRi = 0; apgRi < apgRRTopNum; apgRi++) {
//                    apgRdd = 0; apgRss = 0;
...
//        }
        ...
        for (int y = 0; y < bufferf[0].length; y++){
            bufferFilterf[0][y] = SerialBeanFilterEcg.serialBeanFilter1(bufferf[0][y]);
        }
        ...
        for (int y = 0; y < bufferf[1].length; y++){
            bufferFilterf[1][y] = SerialBeanFilterPcg.serialBeanFilter1(bufferFilterf[1][y]);
            //bufferFilterf[1][y] = bufferf[1][y];
        }
        for (int y = 0; y < bufferf[1].length; y++){
            bufferFilterf[1][y] = SerialBeanFilterPcg.serialBeanFilter2(bufferFilterf[1][y]);
            //bufferFilterf[1][y] = bufferf[1][y];
        }
