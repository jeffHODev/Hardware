...
public class HistoryResultOneActivity extends BaseActivity implements View.OnClickListener {
...
//        ThreadPoolWrapper.shutdown();
        ...
        tv_title.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HistoryResultOneActivity.this, ResultTwoActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                finish();
                Utils.exitActivityAnimation(HistoryResultOneActivity.this);
            }
        });
                    ...
                    if(level2 == 1){
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent intent = new Intent(HistoryResultOneActivity.this, PatientInfomationActivity.class);
                                startActivity(intent);
                            }
                        });
                    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        tv_title.setText("cfPWV = " + ptv / 100 + " m/s");
        xyView.setData(x,y);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.bt_newtext:
                ...
                intent = new Intent(HistoryResultOneActivity.this, PatientInfomationActivity.class);
                startActivity(intent);
                break;
            case R.id.bt_next:
                istrue = false;
                ...
                intent = new Intent(HistoryResultOneActivity.this, ResultTwoActivity.class);
                startActivity(intent);
