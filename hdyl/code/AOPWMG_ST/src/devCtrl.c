...
void DcMotorCtrl(unsigned char motorNo,uint32_t pwm)
{
    ...
    {
    case 1:
        timer_channel_output_pulse_value_config(TIMER4, TIM_CHANNEL_1, pwm);
        break;
    case 2:
        timer_channel_output_pulse_value_config(TIMER4, TIM_CHANNEL_2, pwm);
        break;
    case 3:
        timer_channel_output_pulse_value_config(TIMER4, TIM_CHANNEL_3, pwm);
        break;
    default:
        timer_channel_output_pulse_value_config(TIMER4, TIM_CHANNEL_1, pwm);
        timer_channel_output_pulse_value_config(TIMER4, TIM_CHANNEL_2, pwm);
