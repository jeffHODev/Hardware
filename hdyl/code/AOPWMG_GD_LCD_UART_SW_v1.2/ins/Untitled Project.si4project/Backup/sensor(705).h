...
#define MAX_TDS_VALUE  1300 //进水tds阈值  0  1300
#define MIN_TDS_VALUE  0

#define MAX_TDS1_VALUE  150  //原水tds阈值 150
...
#define WASH_TIME_SETTING        20000//3*60000   //wash time setting
