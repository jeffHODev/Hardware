...
uint8_t touch_pro()
{
    ...
    {
        if(touch_usr.page_id == Main_PAGE)
        {
        ...
        if(touch_usr.page_id == CALIBRATION_PAGE)//CALIBRATION
        {
            ...
            if(touch_usr.status == 0x55)
            {
                ...
                if(touch_usr.control_id == PH1_CAL_ID||touch_usr.control_id == PH2_CAL_ID)//PH calibration
                {
                    ...
                    if(touch_usr.control_id == PH2_CAL_ID)
                    {
                        inout_usr.key_cali_value = 4;
                    }
                }
                else if(touch_usr.control_id == PH1_CAL_OK_ID||touch_usr.control_id == PH2_CAL_OK_ID)
                {
                    ...
                    {
                        inout_usr.key_cali_value = 10;
                        getTouch()->last_ctrl_id = 0;

                    }
                    if(getTouch()->last_ctrl_id == PH2_CAL_ID)
                    {
                        inout_usr.key_cali_value = 11;
                        getTouch()->last_ctrl_id = 0;
                    }
                }
                else if(touch_usr.control_id == ORP_CAL_ID)//ORP calibration
                {
                ...
                else if(touch_usr.control_id == ORP_CAL_OK_ID)
                {
