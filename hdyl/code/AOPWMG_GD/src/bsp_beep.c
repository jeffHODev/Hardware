 ...
 timer_oc_parameter_struct timer_ocintpara;
...
#else
	   timer_channel_output_pulse_value_config(TIMER0,TIMER_CH_3,65535);
...
#else
		   timer_channel_output_pulse_value_config(TIMER0,TIMER_CH_3,(_ulDutyCycle * usPeriod) / 10000);
  ...
  rcu_periph_clock_enable(RCU_GPIOA);
		 ...
		 /* -----------------------------------------------------------------------
			...
			timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_3,65535/2);
